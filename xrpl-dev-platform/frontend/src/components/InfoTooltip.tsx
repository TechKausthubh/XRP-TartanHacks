  ...
  return (
    <div className="relative inline-flex" ref={ref}>
      <button
        ...
        className="ml-1.5 text-white/50 hover:text-xrpl-accent focus:outline-none"
        title={title}
        aria-label={title}
      >
      ...
      {open && (
        <div className="absolute left-6 top-0 z-10 w-72 p-3 glass rounded-lg shadow-xl text-left bg-white/[0.06]">
