...
From the `xrpl-dev-platform` folder:
...
Open **two terminals** in `xrpl-dev-platform`.
...
Import the **Postman collection** from `postman/XRPL-Dev-Platform.postman_collection.json`, or download it from the Dev Quickstart page.
